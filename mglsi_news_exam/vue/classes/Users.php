...
include 'l/lib/Database.php';
include_once 'l/lib/Session.php';
...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
      ...
      $sql = "INSERT INTO tbl_users(name, username, email, password, mobile, role) VALUES(:name, :username, :email, :password, :mobile, :role)";
      $stmt = $this->db->pdo->prepare($sql);
