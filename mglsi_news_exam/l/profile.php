      ...
      <div style="width:600px; margin:0px auto">
        ...
        <form class="" action="" method="POST">
          ...
          <?php if (Session::get("role") == '1') { ?>
            ...
            <div class="form-group
              <?php if (Session::get("role") == '1' && Session::get("id") == $getUinfo->id) {
                echo "d-none";
              } ?>
              ">
              <div class="form-group">
                ...
                <select class="form-control" name="role" id="role">
                  ...
                  <?php } elseif ($getUinfo->role == '2') { ?>
                    <option value="1">Admin</option>
                    <option value="2" selected='selected'>Editor</option>
                    <option value="3">User only</option>
                  <?php } elseif ($getUinfo->role == '3') { ?>
                    <option value="1">Admin</option>
                    <option value="2">Editor</option>
          ...
          <?php } else { ?>
            <input type="hidden" name="role" value="<?php echo $getUinfo->role; ?>">
          <?php } ?>
